    ...
    plugins: [
      ...
      */
      new HtmlWebpackPlugin({
        ...
        title: core.PROJECT.toLowerCase().replace( /\b./g, function(a){ return a.toUpperCase(); } ),
      ...
      new webpack.DefinePlugin({
        'process.env': {
          PROJECT: JSON.stringify(core.PROJECT.toLowerCase().replace( /\b./g, function(a){ return a.toUpperCase(); } )),
          API_URL: JSON.stringify(core[options.env].API_URL),
          API_VS: JSON.stringify(core.API_VS),
          API_PREFIX: JSON.stringify(core[options.env].API_PREFIX),
          APP_VS: JSON.stringify('v' + pkg.version)
        }
      })
    ],
