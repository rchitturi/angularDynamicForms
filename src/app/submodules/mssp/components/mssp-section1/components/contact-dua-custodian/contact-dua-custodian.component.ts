...
@Component({
  selector: 'sd-contact-dua-custodian',
  templateUrl: './contact-dua-custodian.component.html',
  styleUrls: ['./contact-dua-custodian.component.scss'],
  animations: [slideInOutAnimation],
  host: { '[@slideInOutAnimation]': '' }
})
export class ContactDuaCustodianComponent implements OnInit, AfterViewInit {
