...
@Component({
  selector: 'sd-contact-authorized-to-sign',
  templateUrl: './contact-authorized-to-sign.component.html',
  styleUrls: ['./contact-authorized-to-sign.component.scss'],
  animations: [slideInOutAnimation],
  host: { '[@slideInOutAnimation]': '' }
})
export class ContactAuthorizedToSignComponent implements OnInit, AfterViewInit {
