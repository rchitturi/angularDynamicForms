...
@Component({
  selector: 'sd-contact-medical-director',
  templateUrl: './contact-medical-director.component.html',
  styleUrls: ['./contact-medical-director.component.scss'],
  animations: [slideInOutAnimation],
  host: { '[@slideInOutAnimation]': '' }
})
export class ContactMedicalDirectorComponent implements OnInit, AfterViewInit {
