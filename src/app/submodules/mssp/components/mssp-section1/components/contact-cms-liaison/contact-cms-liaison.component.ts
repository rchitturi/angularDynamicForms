...
@Component({
  selector: 'sd-contact-cms-liaison',
  templateUrl: './contact-cms-liaison.component.html',
  styleUrls: ['./contact-cms-liaison.component.scss'],
  animations: [slideInOutAnimation],
  host: { '[@slideInOutAnimation]': '' }
})
export class ContactCmsLiaisonComponent implements OnInit, AfterViewInit {
