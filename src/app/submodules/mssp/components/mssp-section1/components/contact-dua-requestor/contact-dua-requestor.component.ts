...
@Component({
  selector: 'sd-contact-dua-requestor',
  templateUrl: './contact-dua-requestor.component.html',
  styleUrls: ['./contact-dua-requestor.component.scss'],
  animations: [slideInOutAnimation],
  host: { '[@slideInOutAnimation]': '' }
})
export class ContactDuaRequestorComponent implements OnInit, AfterViewInit {
