...
@Component({
  selector: 'sd-contact-it',
  templateUrl: './contact-it.component.html',
  styleUrls: ['./contact-it.component.scss'],
  animations: [slideInOutAnimation],
  host: { '[@slideInOutAnimation]': '' }
})
export class ContactItComponent implements OnInit, AfterViewInit {
