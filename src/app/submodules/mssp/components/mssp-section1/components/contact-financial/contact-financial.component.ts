...
@Component({
  selector: 'sd-contact-financial',
  templateUrl: './contact-financial.component.html',
  styleUrls: ['./contact-financial.component.scss'],
  animations: [slideInOutAnimation],
  host: { '[@slideInOutAnimation]': '' }
})
export class ContactFinancialComponent implements OnInit, AfterViewInit {
