...
@Component({
  selector: 'sd-contact-compliance',
  templateUrl: './contact-compliance.component.html',
  styleUrls: ['./contact-compliance.component.scss'],
  animations: [slideInOutAnimation],
  host: { '[@slideInOutAnimation]': '' }
})
export class ContactComplianceComponent implements OnInit, AfterViewInit {
