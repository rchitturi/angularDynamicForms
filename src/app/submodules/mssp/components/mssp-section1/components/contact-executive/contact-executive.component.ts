...
@Component({
  selector: 'sd-contact-executive',
  templateUrl: './contact-executive.component.html',
  styleUrls: ['./contact-executive.component.scss'],
  animations: [slideInOutAnimation],
  host: { '[@slideInOutAnimation]': '' }
})
export class ContactExecutiveComponent implements OnInit, AfterViewInit {
