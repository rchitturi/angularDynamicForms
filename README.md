...
This is the temp method to build the dev environment. Next version will be 1-click
...
* Ensure you're running the latest versions Node `v6.x.x`+ (or `v8.x.x`) and NPM `3.x.x`+
...
TypeScript 2.3.x includes everything you need. Make sure to upgrade, even if you installed TypeScript previously.
